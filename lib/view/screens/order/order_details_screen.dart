  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        bool _showSlider = (_controllerOrderModer.orderStatus == 'pending' && (_controllerOrderModer.orderType == 'take_away' || _restConfModel || _selfDelivery))
            ...
            || (_controllerOrderModer.orderStatus == 'handover' && (_selfDelivery || _controllerOrderModer.orderType == 'take_away'));
        bool _showBottomView = _showSlider || _controllerOrderModer.orderStatus == 'picked_up' || widget.isRunningOrder;
        ...
        return orderController.orderDetailsModel != null ? Column(children: [
          ...
          Expanded(child: Scrollbar(child: SingleChildScrollView(
            ...
            child: Center(child: SizedBox(width: 1170, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              DateConverter.isBeforeTime(_controllerOrderModer.scheduleAt) ? (_controllerOrderModer.orderStatus != 'delivered' && _controllerOrderModer.orderStatus != 'failed'&& _controllerOrderModer.orderStatus != 'canceled') ? Column(children: [
